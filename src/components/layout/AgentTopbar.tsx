/**
 * @file Agent Topbar component
 * @module components/layout/AgentTopbar
 * @description Top header bar for the agent dashboard area.
 *   Mirrors DashboardTopbar but with agent-specific links in the
 *   user dropdown menu (My Bookings → agent bookings, etc.).
 */
...
function NotificationPanel() {
  ...
  const handleBookingClick = (bookingId?: string) => {
    if (bookingId) {
      navigate(ROUTES.agent.bookingDetail(bookingId));
    }
  };
...
// ───────────────────────────────────────────
//  AgentTopbar (outer shell)
// ───────────────────────────────────────────

/**
 * AgentTopbar
 * @description Renders a top header bar for the agent dashboard. Includes
 *   a mobile hamburger menu toggle, notification bell with dropdown
 *   panel, theme toggle, and a user avatar dropdown with agent-specific
 *   account options.
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem asChild>
              <Link to={ROUTES.agent.root}>Agent Dashboard</Link>
            </DropdownMenuItem>
            <DropdownMenuItem asChild>
              <Link to={ROUTES.agent.profile}>Profile</Link>
            </DropdownMenuItem>
            <DropdownMenuItem asChild>
              <Link to={ROUTES.agent.bookings}>My Bookings</Link>
            </DropdownMenuItem>
            <DropdownMenuSeparator />

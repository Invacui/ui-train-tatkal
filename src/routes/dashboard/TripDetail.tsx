      ...
      <div className="flex flex-col gap-6">
          ...
          <CardContent className="p-6">
            ...
            <div className="mt-6 flex items-center gap-6 text-center">
              <div>
                ...
                <p className="text-sm text-muted-foreground">{train.sourceStationCode}</p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">{train.destinationStationCode}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {train.classes.map((cls) => (
            <Card key={cls.code} className="hover:border-primary/50 transition-colors cursor-pointer" onClick={() => navigate(ROUTES.checkout(train.trainNumber))}>
